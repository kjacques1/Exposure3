...
import {getSummaryReport, getEffortByLangForDoughnutChart} from './Report/selectors.js'
      ...
      <div className="report">
        ...
        </Paper>
        {
          ...
          :
            ...
            :
              <p style={{textAlign: 'center'}}>No entry</p>
        }
      </div>
    )    
  }
...
const mapStateToProps = (state) => {
  return {
    ...
    doughnutChart: getEffortByLangForDoughnutChart(state),
